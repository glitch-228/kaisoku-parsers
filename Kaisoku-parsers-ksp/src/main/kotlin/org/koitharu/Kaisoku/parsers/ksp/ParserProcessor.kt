...
class ParserProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("org.koitharu.Kaisoku.parsers.MangaSourceParser")
        ...
        val factoryFile =
            try {
                codeGenerator.createNewFile(
                    ...
                    packageName = "org.koitharu.Kaisoku.parsers",
        ...
        val sourcesFile =
            try {
                codeGenerator.createNewFile(
                    dependencies = dependencies,
                    packageName = "org.koitharu.Kaisoku.parsers.model",
    ...
    private fun writeContent(
        ...
        factoryWriter?.write(
			...
			import org.koitharu.Kaisoku.parsers.core.MangaParserWrapper
