package org.koitharu.Kaisoku.parsers.site.vi
...
import org.koitharu.Kaisoku.parsers.model.Favicon
import org.koitharu.Kaisoku.parsers.model.Favicons
...
import org.koitharu.Kaisoku.parsers.util.json.mapJSON
import org.koitharu.Kaisoku.parsers.util.json.mapJSONToSet
...
internal class OTruyenParser(context: MangaLoaderContext) :
	...
	override val userAgentKey = ConfigKey.UserAgent(UserAgents.Kaisoku)
