package org.koitharu.Kaisoku.parsers.site.en
...
import org.koitharu.Kaisoku.parsers.MangaParserAuthProvider
import org.koitharu.Kaisoku.parsers.MangaSourceParser
import org.koitharu.Kaisoku.parsers.config.ConfigKey
import org.koitharu.Kaisoku.parsers.core.AbstractMangaParser
import org.koitharu.Kaisoku.parsers.model.ContentRating.SAFE
import org.koitharu.Kaisoku.parsers.model.ContentRating.SUGGESTIVE
import org.koitharu.Kaisoku.parsers.model.ContentType.COMICS
import org.koitharu.Kaisoku.parsers.model.ContentType.MANGA
import org.koitharu.Kaisoku.parsers.model.ContentType.MANHUA
import org.koitharu.Kaisoku.parsers.model.ContentType.MANHWA
...
import org.koitharu.Kaisoku.parsers.model.MangaState.ABANDONED
import org.koitharu.Kaisoku.parsers.model.MangaState.FINISHED
import org.koitharu.Kaisoku.parsers.model.MangaState.ONGOING
import org.koitharu.Kaisoku.parsers.model.MangaState.PAUSED
...
import org.koitharu.Kaisoku.parsers.model.SortOrder.ADDED
import org.koitharu.Kaisoku.parsers.model.SortOrder.ADDED_ASC
import org.koitharu.Kaisoku.parsers.model.SortOrder.ALPHABETICAL
import org.koitharu.Kaisoku.parsers.model.SortOrder.ALPHABETICAL_DESC
import org.koitharu.Kaisoku.parsers.model.SortOrder.POPULARITY
import org.koitharu.Kaisoku.parsers.model.SortOrder.POPULARITY_ASC
import org.koitharu.Kaisoku.parsers.model.SortOrder.RATING
import org.koitharu.Kaisoku.parsers.model.SortOrder.RATING_ASC
import org.koitharu.Kaisoku.parsers.model.SortOrder.RELEVANCE
import org.koitharu.Kaisoku.parsers.model.SortOrder.UPDATED
import org.koitharu.Kaisoku.parsers.model.SortOrder.UPDATED_ASC
import org.koitharu.Kaisoku.parsers.util.LinkResolver
import org.koitharu.Kaisoku.parsers.util.attrAsAbsoluteUrl
import org.koitharu.Kaisoku.parsers.util.attrAsAbsoluteUrlOrNull
import org.koitharu.Kaisoku.parsers.util.generateUid
import org.koitharu.Kaisoku.parsers.util.getCookies
import org.koitharu.Kaisoku.parsers.util.mapChapters
import org.koitharu.Kaisoku.parsers.util.mapToSet
import org.koitharu.Kaisoku.parsers.util.nullIfEmpty
import org.koitharu.Kaisoku.parsers.util.parseHtml
import org.koitharu.Kaisoku.parsers.util.parseSafe
