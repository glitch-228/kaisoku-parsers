...
internal class Chikari(context: MangaLoaderContext) :
    ...
    private fun okhttp3.Response.toJSONArray(): JSONArray {
        val body = body?.string() ?: throw org.koitharu.kotatsu.parsers.exception.ParseException("Empty response body", request.url.toString())
