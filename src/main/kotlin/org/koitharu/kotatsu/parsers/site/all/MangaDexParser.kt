...
internal class MangaDexParser(context: MangaLoaderContext) : FlexibleMangaParser(context, MangaParserSource.MANGADEX) {
	...
	// MangaDex's API returns HTTP 400 for browser-like User-Agents; the inherited default
	// (context.getDefaultUserAgent() = the WebView UA) trips this. Default to an app UA instead.
