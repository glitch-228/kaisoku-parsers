...
internal abstract class LikeMangaParser(
	...
	// Pin a regular Chrome-mobile User-Agent. The host app's default UA is Android System
	// WebView's, which includes a "; wv" token — that token alone is enough for CloudFlare's
	// bot score on like.mgread.io to flip from "allow" to "blocked". Verified empirically:
	// same IP, same Referer, identical request — Chrome UA returns 200, "; wv" UA returns 403.
